...
public class GetByIdQueryHandlerTest {
    ...
    private GetPictureByIdQueryHandler handler;

    @BeforeEach
    void setUp() {
        pictureRepository = mock(PictureRepository.class);
        pictureMapper = mock(PictureMapper.class);
        handler = new GetPictureByIdQueryHandler(pictureRepository, pictureMapper);
    }
    ...
    void handle_givenExistingPicture_shouldReturnPictureDto() {
        ...
        // When
        PictureDto result = handler.handle(new GetPictureByIdQuery(1));
    ...
    void handle_givenNonExistingPicture_shouldThrowPictureNotFoundException() {
        ...
        // When / Then
        assertThrows(PictureNotFoundException.class, () -> handler.handle(new GetPictureByIdQuery(999)));
